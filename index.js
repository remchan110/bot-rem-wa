...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN: JOSUA SILALAHI\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6283190821476:+6283190821476\n' 
            + 'END:VCARD' 
blocked = []   
prefix = '#'
limitawal = 25
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6283190821476@s.whatsapp.net"] 
/************************************/
...
❍█╰━━━━━━━━━━━━━`
				...
				teks = `akhirnya beban group berkurang 𝟭,bye bye🥳 @${num.split('@')[0]} kalau join lagi gua santet lu🗿`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
   ...
   if (isLimit(sender)) return reply(ind.limitend(pusname)) 
    ...
    break
			...
			case 'readall':
               ...
               case 'help': 
				...
				case 'blocklist': 
					...
					break 
				case 'donasi':083190821476
				case 'donate':083190821476
				if (!isRegistered) return reply(ind.noregis())
					client.sendMessage(from, donasi(), text)
					break
				case 'admin':josua silalahi
         	   case 'owner':josua silalahi
         	   case 'creator':josua silalahi
            ...
            break
                ...
                addKoinUser('6283190821476@s.whatsapp.net', fee)
